...
const EventsSection: React.FC = () => {
  ...
  const programs = [
    ...
    },
    {
      ...
      desc: "Strengthening internal bonds and alumni networking. Schedule discussed during MoU signing (Target: March/Ramadan or Early April).",
    ...
    {
      id: 4,
      title: "Tech Goes To School",
      desc: "Visiting high schools to provide technology workshops and training sessions for students.",
      date: "May 2026 (Week 3)",
      time: "TBA",
      location: "High Schools (Semarang)",
      image:
    ...
    },
    {
      ...
      desc: "Field trip to major technology companies to gain real-world industry insights and networking.",
      date: "June 2026",
      time: "TBA",
      location: "TBA",
      image:
    ...
    {
      id: 6,
      title: "EIE: Seminar Talk Show",
      desc: "Engineering Informatics Event: A high-profile seminar and talk show featuring industry experts.",
      date: "October 2026 (Week 3)",
      time: "TBA",
      location: "TBA",
      image:
    ...
    {
      id: 7,
      title: "Staff Open Recruitment",
      desc: "Opening opportunities for dedicated students to join the HMPS-TI board for the next period.",
      date: "November 2026",
      time: "TBA",
      location: "TBA",
      image:
    ...
    {
      id: 8,
      title: "Leadership Succession Interviews",
      desc: "Intensive selection and interview process for the next Director and Vice Director candidates.",
      date: "December 2026",
      time: "TBA",
      location: "TBA",
      image:
    ...
    {
      id: 9,
      title: "Grand Reorganization",
      desc: "Official restructuring and inauguration of the organization for the 2027 tenure.",
      date: "January 2027",
      time: "TBA",
      location: "TBA",
      image:
  ...
  return (
    <div className="space-y-12">
      <SectionHeader
        title="Work Programs 2026"
        subtitle="Our strategic roadmap and activities for the year."
      />
