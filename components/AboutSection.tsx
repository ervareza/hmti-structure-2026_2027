    ...
    <div className="space-y-24">
      ...
      <section className="flex flex-col md:flex-row gap-12 items-center">
        <div className="w-full md:w-1/2">
          ...
          <p className="text-xl text-slate-500 leading-relaxed max-w-lg">
            The official student association for the Informatics Engineering
            Study Program at UNISBANK.
          </p>
        </div>
        <div className="w-full md:w-1/2 h-[400px] bg-slate-900 rounded-[3rem] relative overflow-hidden flex items-center justify-center p-12 group">
          ...
          <div className="relative z-10 text-center space-y-4">
            <img
              src="/logo.png"
              alt="HMPS-TI Logo"
              className="w-24 h-24 object-contain mx-auto mb-4 brightness-0 invert"
            />
      ...
      <section className="bg-white border border-slate-100 rounded-[3rem] p-10 md:p-16 shadow-sm">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <h3 className="text-3xl md:text-4xl font-bold text-slate-900 leading-tight">
            From "Walking Alone" to{" "}
            <span className="text-lime-500">"Moving Forward Together"</span>.
          </h3>
          <p className="text-lg text-slate-500 leading-relaxed">
            This vision and mission represent the commitment of the HMTI
            Director to transform the association into more than just a
            gathering place—it is an <strong>incubator for growth</strong>. We
            focus on active collaboration with other student associations and
            external organizations. Our goal is to create Informatics
            Engineering graduates who are not only technically skilled but also
            adaptable leaders with extensive networks.
          </p>
        </div>
      </section>
      ...
      <section>
        <SectionHeader
          ...
          subtitle="Vision & Mission 2026/2027."
        />
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="bg-lime-400 rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden group">
            ...
            <p className="text-slate-900 text-lg font-medium leading-relaxed">
              Realizing HMPS Informatics Engineering of Stikubank University as
              an adaptive and achievement-oriented self-development ecosystem,
              and building collaborative connectivity across organizations to
              produce superior and competitive informatics graduates.
            </p>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-[2.5rem] p-10 md:p-14 relative overflow-hidden">
            ...
            <ul className="space-y-6">
              <li className="flex items-start gap-4 text-slate-600 font-medium text-lg">
                <span className="bg-lime-100 text-lime-700 p-2 rounded-lg shrink-0">
                  <Users size={20} />
                </span>
                <span>
                  Facilitate an <strong>inclusive growth space</strong> for all
                  members to hone technological hard skills and leadership soft
                  skills.
                </span>
              </li>
              <li className="flex items-start gap-4 text-slate-600 font-medium text-lg">
                ...
                <span>
                  Expand <strong>strategic cooperation networks</strong> with
                  fellow HMPS, other student organizations, and IT communities.
                </span>
              </li>
              <li className="flex items-start gap-4 text-slate-600 font-medium text-lg">
                <span className="bg-lime-100 text-lime-700 p-2 rounded-lg shrink-0">
                ...
                <span>
                  Build a <strong>harmonious and supportive</strong>{" "}
                  organizational climate, turning cohort differences into a
              ...
              <li className="flex items-start gap-4 text-slate-600 font-medium text-lg">
                ...
                <span>
                  Present{" "}
                  <strong>relevant, creative, and solution-oriented</strong>{" "}
                  work programs beneficial to students and the campus
                  environment.
                </span>
              </li>
            </ul>
