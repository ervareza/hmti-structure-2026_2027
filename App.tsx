...
const App: React.FC = () => {
  ...
  const getBPH = () => {
    ...
    const others = allBPH.filter(
      (m) => m.role !== "DIRECTOR" && m.role !== "VICE DIRECTOR",
    );
        ...
        <nav className="max-w-7xl mx-auto bg-white/90 backdrop-blur-xl border border-slate-200 rounded-full px-6 py-3 flex items-center justify-between shadow-lg shadow-slate-200/40">
          ...
          >
            ...
            <span className="font-bold text-xl tracking-tight">
              HMPS-TI<span className="text-lime-500">.</span>
            </span>
          </div>
        ...
        <AnimatePresence>
          {isMobileMenuOpen && (
            ...
            >
              <button
                onClick={() => navigateTo("structure")}
                className="text-left font-semibold text-lg p-2"
              >
                Structure
              </button>
              <button
            ...
            >
                ...
                <section className="relative py-10 md:py-20 text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-12">
                  <div className="max-w-2xl space-y-6">
                    ...
                    >
                      <Sparkles
                        size={14}
                        className="text-lime-600 fill-lime-600"
                      />
                      UNISBANK SEMARANG
                    </motion.div>
                    <motion.h1
                    ...
                    >
                      ...
                      For <br />
                      <span className="underline decoration-lime-400/50 decoration-4 underline-offset-4">
                        HMPS-TI.
                      </span>
                    </motion.h1>
                    <motion.p
                    ...
                    >
                      The official structural organization of Informatics
                      Engineering Students at {UNIVERSITY_NAME}{" "}
                      {ORGANIZATION_YEAR}.
                    </motion.p>
                    ...
                    >
                      <button
                        onClick={() => navigateTo("events")}
                        className="bg-black text-white px-8 py-4 rounded-full font-bold flex items-center gap-2 hover:bg-slate-800 transition-all"
                      >
              ...
              {(direktur || wakil) && hasAnyResults && (
                <section>
                  <SectionHeader
                    title="Leadership"
                    subtitle="The visionaries guiding our path forward."
                  />
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    {direktur && (
                      <MemberCard member={direktur} variant="primary" />
                    )}
              ...
              {hasAnyResults &&
                divisions.map((div) => {
                  ...
                  const koor = divMembers.find((m) =>
                    m.role.includes("COORDINATOR"),
                  );
                  const members = divMembers.filter(
                    (m) => !m.role.includes("COORDINATOR"),
                  );
                  ...
                  return (
                    <section key={div} className="relative">
                      <SectionHeader
                        title={div}
                        subtitle={`Dedicated team for ${div} excellence.`}
                      />
                      ...
                      <div className="flex flex-col lg:flex-row gap-8">
                            ...
                            <div className="sticky top-32">
                              ...
                              <div className="mt-6 p-6 bg-slate-900 rounded-3xl text-white">
                                ...
                                <p className="text-slate-400 text-sm leading-relaxed">
                                  Focusing on strategic initiatives and
                                  operational excellence within the{" "}
                                  {div.toLowerCase()} domain of HMPS-TI.
                                </p>
                              </div>
                            </div>
                          </div>
                        ...
                        <div
                          className={`grid grid-cols-1 sm:grid-cols-2 gap-6 ${koor ? "lg:w-2/3" : "w-full lg:grid-cols-3"}`}
                        >
                          {members.map((m) => (
                            <MemberCard key={m.no} member={m} />
                          ))}
          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-12 mb-16">
            <div className="max-w-md">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-4xl font-bold">
                  HMPS-TI <br /> <span className="text-lime-400">UNISBANK</span>
                </h2>
              </div>
              <div className="flex items-center gap-4">
                <p className="text-slate-400 leading-relaxed">
                  Building the future of technology through student innovation
                  and entrepreneurship in Semarang.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-12 text-sm text-slate-400">
              ...
              <div className="space-y-4">
                ...
                <a
                  href="https://wa.me/6285702816894"
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-2 cursor-pointer hover:text-lime-400 transition-colors"
                >
